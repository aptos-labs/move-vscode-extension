...
#[test]
fn test_resolve_public_struct_constructor() {
    // language=Move
    check_resolve(
        r#"
        module 0x1::s {
...
#[test]
fn test_resolve_public_struct_constructor_field() {
    // language=Move
    check_resolve(
        r#"
        module 0x1::s {
...
#[test]
fn test_resolve_public_struct_dot_field() {
    // language=Move
    check_resolve(
        r#"
        module 0x1::s {
...
#[test]
fn test_public_enum_match_field() {
    // language=Move
    check_resolve(
        r#"
        module 0x1::s {
