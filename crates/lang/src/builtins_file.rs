...
pub const BUILTINS_FILE: &str = r#"
    module 0x0::builtins {
        ...
        const MAX_I8: i8 = 255;
        const MAX_I16: i16 = 65535;
        const MAX_I32: i32 = 4294967295;
        const MAX_I64: i64 = 18446744073709551615;
        const MAX_I128: i128 = 340282366920938463463374607431768211455;
        const MAX_I256: i256 = 115792089237316195423570985008687907853269984665640564039457584007913129639935;
        ...
        spec native fun range<T>(v: vector<T>): range<num>;
